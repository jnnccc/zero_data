subroutine DE_Fortran90(obj, Dim_XC, XCmin, XCmax, VTR, NP, itermax, F_XC, &
           CR_XC, strategy, refresh, bestmem_XC, bestval, nfeval, &
                   F_CR, method)
!.......................................................................
!    
...
!                   = other, displaying results only.
         ...
         use param, only : IB, RP
         implicit none	
	integer(kind=IB), intent(in) :: NP, Dim_XC, itermax, strategy,refresh
...
201 format(2x, 'bestval =', E15.7, /)
202 format(5x, 'bestmem_XC(', I3, ') =', E15.7)
